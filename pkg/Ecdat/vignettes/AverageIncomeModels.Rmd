...
4 | EWMA2pres2: EWMA2 estimating mean slope and no continuity between presidents | 2:level, slope | Q, T | 3:lnQ.lvl, lnQ.slope, lnH 
...
Formally at least, we have the same parameters to estimate as with EWMA2pres1.  However, we can set $P_{2,2,1}$ to match $Q_{2,2,t}$ for the last year of each presidency;  note that P1 = "num [1:2, 1:2, 1] 0 0 0 0" in "str(EWMA2mdl)" above.  We also want to estimate the slope component of a1
...
plotPresWars(GDP$Year, EWMA2pres2.KFS$V[2,2,], GDP, 
             yHoover=0.72, yFDR=.3, yWar=seq(.6, by=-.08, len=9), 
